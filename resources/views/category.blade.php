...
@section('content')
    <div class="flex flex-wrap lg:flex-nowrap gap-6">
        ...
        <div class="flex-1 bg-white shadow-md rounded p-4">
            <h2 class="text-xl font-bold mb-4">Category {{ $currentCategory->name }}</h2>
            <div class="space-y-6">
                @if($news->isEmpty())
                    <p>Няма новини за тази категория.</p>
                @else
                @foreach($news as $item)
                    <div class="flex items-center space-x-6 news-card bg-white rounded-lg p-4 shadow-lg">
                        <!-- Image Section -->
                        <div class="w-1/3">
                        ...
                        <div class="w-2/3">
                            ...
                            <div class="text-xs text-gray-700 mt-3">
                                <p>
                                    ...
                                    Коментари: <a href="#" class="text-blue-500">{{ $item->comments_count }}</a> |
