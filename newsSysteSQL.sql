...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 29, 2024 at 08:09 AM
...
ALTER TABLE `news_views`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `news_views_news_id_user_id_unique` (`news_id`,`user_id`),
  ADD UNIQUE KEY `news_views_news_id_ip_address_unique` (`news_id`,`ip_address`),
  ADD KEY `news_views_user_id_foreign` (`user_id`);
...
--
ALTER TABLE `poll_votes`
  ADD CONSTRAINT `poll_votes_option_id_foreign` FOREIGN KEY (`option_id`) REFERENCES `poll_options` (`id`),
  ADD CONSTRAINT `poll_votes_poll_id_foreign` FOREIGN KEY (`poll_id`) REFERENCES `polls` (`id`),
  ADD CONSTRAINT `poll_votes_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
